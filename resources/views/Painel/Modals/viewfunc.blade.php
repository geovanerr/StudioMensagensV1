...
<div class="row">
                          ...
                          <div class="col-xs-3">
                          Bairro:
                          <input type="text" id="bairro" class="form-control" placeholder="N°">
                          ...
                          <div class="col-xs-4">
                          <div class="form-group">
                          Nascimento: <input type="text" name="nascimento" class="form-control pull-right">
                          </div>
                          </div>
</div>  
...
<div class="row">
                          ...
                          <div class="form-group">
                          Gênero:
                          <input type="text" name="genero" class="form-control pull-right">
                          ...
                          <div class="form-group">
                          Função:
                          <input type="text" name="funcao" class="form-control pull-right">
