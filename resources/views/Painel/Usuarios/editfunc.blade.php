...
<div class="box box-info">
  <div class="container">
            ...
            <div class="row">
                          ...
                          <option value="{{$bairro->id}}" @if(in_array($bairro->id, $usuario->bairro->pluck('id')->toArray())) selected="selected" @endif> {{$bairro->bairro}} </option>
                          ...
                          <option value="Feminino" {{($usuario->funcao ==='Feminino') ? 'selected' : ''}}> Feminino </option>
